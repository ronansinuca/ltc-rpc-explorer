module.exports = {
	...
	"routes":[
		...
		// blockchain
		{
			...
			"desc":"Returns the current supply of Litecoin. An estimate using a checkpoint can be returned in 2 cases: on 'slow' devices, and before the UTXO Set snapshot is loaded."
		},
		{
			"category":"blockchain",
		...
		// mempool
		{
			"category":"mempool",
			"url":"/mempool/count",
			"desc":"Returns the number of transactions in Litecoin Core's mempool."
		},
		{
			"category":"mempool",
			"url":"/mempool/summary",
			"desc":"Returns a summary of Litecoin Core's mempool (full output from 'getmempoolinfo')",
		...
		// price
		{
			"category":"price",
			"url":"/price",
			"desc":"Returns the price of 1 LTC, in USD, EUR, GBP, and XAU",
			"optionalParams": {
		...
		},
		{
			"category":"price",
			"url":"/price/marketcap",
			"desc":"Returns the market cap of Litecoin, in USD, EUR, GBP, XAU",
		},
		{
			"category":"price",
			"url":"/price/sats",
